...
function exibirAvaliacoesDetalhesExtensoes() {
    ...
    cards.forEach(card => {
        ...
        // Verificar se já existe um elemento de avaliação e removê-lo
        const avaliacaoExistente = card.querySelector('.flex.flex-col.items-center.mt-2');
        if (avaliacaoExistente) {
            avaliacaoExistente.remove();
        }
